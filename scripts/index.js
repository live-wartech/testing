...
window.addEventListener("load", function () {
  ...
  document.getElementById(
    "topvideo"
  ).innerHTML = `<video class="embed-responsive-item" src="https://res.cloudinary.com/rk22719/video/upload/v1644071144/hearthand_wouphr.mp4" type="video/mp4" autoplay muted loop></video>`; // muted loop
});
...
function onAccepting(e) {
  ...
  async function getData() {
    ...
    request.open(
      "GET",
      "https://res.cloudinary.com/rk22719/video/upload/v1644070720/onaccept_vrcwuf.mp3",
      true
    );
  ...
  document.getElementById(
    "main_content"
  ).innerHTML = `<div class="topleft animate__animated"><div style="background-color: red;top: 50%;position: absolute;left: 50%;width:100px;height: 100px;border-radius: 50%;transform: translate(-50%,-50%);"></div></div>
...
<div class="letter-image ">
  <div class="animated-mail animate__animated">
    ...
    <div class="letter p-2 ">
      ...
      <div class="text-left dynamic_vnm">${
        queryDict["vnm"].charAt(0).toUpperCase() + queryDict["vnm"].slice(1)
      }💘</div>
...
Karena kamu suka bgt dots, nih aku kasih dots virtual wkwkwk😛😜 Klik kadonya dibawah. Amplopnya jg klik bolehh
...
<div class="birthday-gift animate__animated ">
  ...
  <div class="wishes text-danger" ><img src="dots.jpg" class="img-fluid" style="width: 36% !important;"></div>
       <div class="sparkles">
...
<div class="footer animate__animated w-100">
  ...
  document
    .getElementsByClassName("below_mail")[0]
    .classList.add("animate__zoomInUp");
  document
    .getElementsByClassName("animated-mail")[0]
    .classList.add("animate__zoomInDown");
  document
    .getElementsByClassName("topleft")[0]
    .classList.add("animate__slideInLeft");
  document
    .getElementsByClassName("topright")[0]
    .classList.add("animate__slideInRight");
  document
    .getElementsByClassName("birthday-gift")[0]
    .classList.add("animate__jackInTheBox");
  document
    .getElementsByClassName("footer")[0]
    .classList.add("animate__rotateIn");
  ...
  emailjs.send("service_an9kfit", "template_4mxgi66", templateParams).then(
    function (response) {
...
function onRejection(e) {
  ...
  async function getData() {
    ...
    request.open(
      "GET",
      "https://res.cloudinary.com/rk22719/video/upload/v1644070731/onbroken_mtk2cz.mp3",
      true
    );
  ...
  document.getElementById(
    "main_content"
  ).innerHTML = `<div style="background-color:rgba(255,255,255,0.8);"><p style="font-size: 30px;text-align:center;color:purple;"> </p><br/><p style="font-size: 30px;text-align:center;color:purple;">Be always happy like this &#128578;&#128077; ,Good bye</p></div>`;
